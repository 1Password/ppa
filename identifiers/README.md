...
In the sample Python code, that is the behavior if no key is provided when creating a new
Anonymizer
...
In the demonstration code, there is a function, `anonymize_field(field_name: str)` designed for this purpose.
